...
public class JSONAPIHook {
    ...
    public void onPluginEnable(boolean enableJSONAPI) {
        ...
        if (this.enabled) {
            ...
            if (plug != null) {
                plug.registerMethod("{" + "   \"name\": \"isVanished\"," + "   \"desc\": \"Checks if named player is vanished\"," + "   \"call\": \"Plugins.VanishNoPacket.isVanished(0)\"," + "   \"returns\": [\"boolean\", \"True if player is invisible. False if offline or visible.\"]," + "   \"args\": [" + "       [\"String\", \"Player's name\"]" + "   ]" + "}");
            }
        }
    }
